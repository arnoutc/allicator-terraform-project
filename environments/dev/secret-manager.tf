resource "aws_secretmanager_secret" "webhook_secret" {
  name = "webhook/secret"
...
resource "aws_secretmanager_secret_version" "webhook_secret_v1" {
  secret_id = aws_secretmanager_secret.webhook_secret.id
